...
import {Text,Heading, Container, Stack, VStack, Avatar, Button, Box, HStack } from '@chakra-ui/react'
...
const Founder =() =>(    <Stack direction={['column','row']} spacing={['4','16']} padding={'8'}>
        <VStack>
            <Avatar boxSize={['40','48']} src="./../../assets/images/boy.png"/>
...
const TandC=({termsAndConditon})=>(
    <Box>
        ...
        <Box h="sm" p="4" overflowY={'scroll'}>
            <Text 
            fontFamily={'heading'}
            letterSpacing={'widest'} textAlign={['center','left']}>{termsAndConditon}</Text>
            <Heading 
            my="4" 
            size={'xs'} 
